...
void Silly_Init(void) {
    ...
    AD_Init();
    AD_AddPins(AD_PORTV3 | AD_PORTV4 | AD_PORTV5 | AD_PORTV6 | AD_PORTV7 | AD_PORTV8 | AD_PORTW7);
...
unsigned char Silly_FullFoward(void) {
    Silly_LeftMtrSpeed(MOTOR_100, FOWARD);
    Silly_RightMtrSpeed(MOTOR_100, FOWARD);
    return TRUE;
}

unsigned char Silly_FullBackward(void) {
    Silly_LeftMtrSpeed(MOTOR_100, BACKWARD);
    Silly_LeftMtrSpeed(MOTOR_100, BACKWARD);
    return TRUE;
}
